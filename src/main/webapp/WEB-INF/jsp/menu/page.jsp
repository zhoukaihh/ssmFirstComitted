    ...
    pageEncoding="UTF-8"%>
            ...
            $(document).ready(function() {
                ...
                $('#' + tableId + ' tbody').on( 'click', 'a', function () {
                	// this表示a标签对应dom，$(this)将其转为jQuery对象，获取按钮所在行的json对象，及MenuDto
            ...
            function createMenu () {
            	...
            	$('#menuDialog').remove();
            	$('body').append ('<div class="modal fade" id="menuDialog" tabindex="-1" role="dialog" aria-labelledby="menuModalLabel"></div>');
            	// 显示对话框
            	$('#menuDialog').load ('${pageContext.request.contextPath}/menu/create', function () {
            ...
            function createChild (id) {
            	...
            	$('body').append ('<div class="modal fade" id="menuDialog" tabindex="-1" role="dialog" aria-labelledby="menuModalLabel"></div>');
            	// 显示对话框
            	$('#menuDialog').load ('${pageContext.request.contextPath}/menu/createChild?id=' +id, function () {
            		$('#menuDialog').modal ('show');
            	});
            	// $('#page-wrapper').load ('${pageContext.request.contextPath}/menu/create');
            }
            ...
            function updateMenu (id) {
            	...
            	$('body').append ('<div class="modal fade" id="menuDialog" tabindex="-1" role="dialog" aria-labelledby="menuModalLabel"></div>');
            	// 显示对话框
            	$('#menuDialog').load ('${pageContext.request.contextPath}/menu/update?id=' +id, function () {
            		$('#menuDialog').modal ('show');
            	});
            	// $('#page-wrapper').load ('${pageContext.request.contextPath}/menu/create');
            }
